...
(2)体验提升: 
  ...
  2.git revert和git restore的实践
  3.变量的管理：每个作用域下的变量应该尽可能少(现实中由于项目成员的流失更换，导致的新成员对以前变量逻辑的不理解，且加之项目的压力，更不会去深入了解，而在原代码基础上重新声明重复的新变量导致变量失控)。
  4.对所有的包、库、项目应该添加详尽的说明文件。说明文件归纳，查看
  # 参考文献
